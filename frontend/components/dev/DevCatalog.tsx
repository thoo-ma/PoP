...
const CATALOG: CatalogSection[] = [
  ...
  },
  {
    ...
    entries: [
      ['ds:alert', 'Alert'],
      ['ds:avatar', 'Avatar'],
      ['ds:badge-overlay', 'BadgeOverlay'],
      ['ds:breed-outcome-panel', 'Breed Outcome Panel'],
      ['ds:breed-parent-slot', 'Breed Parent Slot'],
      ['ds:breed-picker-item-card', 'Breed Picker Item Card'],
      ['ds:button', 'Button'],
      ['ds:card', 'Card'],
      ['ds:chip', 'Chip'],
      ['ds:degen-bar', 'DegenBar'],
      ['ds:dialog', 'Dialog'],
      ['ds:empty-state', 'EmptyState'],
      ['ds:mystery-box-card', 'MysteryBox Card'],
      ['ds:nft-card', 'NFTCard'],
      ['ds:nft-detail-card', 'NFT Detail Card'],
      ['ds:nft-properties', 'NFT Properties'],
      ['ds:oauth-button', 'OAuthButton'],
      ['ds:pressable-feedback', 'PressableFeedback'],
      ['ds:progress-bar', 'ProgressBar'],
      ['ds:screen-error', 'ScreenError'],
      ['ds:screen-loader', 'ScreenLoader'],
      ['ds:select', 'Select'],
      ['ds:slider', 'Slider'],
      ['ds:spinner', 'Spinner'],
      ['ds:tag-group', 'TagGroup'],
