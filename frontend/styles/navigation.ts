...
export const floatingNavButton = tv({
  base: 'absolute top-[60px] z-[100] p-2 bg-[rgba(255,255,255,0.9)] rounded-[20px] shadow-md',
  variants: {
    side: {
      left: 'left-5',
      right: 'right-5',
...
export const pageIndicator = tv({
  slots: {
    ...
    rail: 'flex-row bg-[rgba(255,255,255,0.95)] rounded-[24px] px-4 py-[10px] gap-1 shadow-md',
